...
class FileParserServiceImplTest {
    ...
    fun parseFile_returnsParsedRecords_forValidCsvResource() {
        ...
        val expectedSecondRow = listOf("9999","Test cursus - September 2010","2010-09-01 00:00:00+02:00","2011-01-30 23:59:59+01:00","John Doe","john.doe@student.hu.nl","STUDENT")
        val secondResultRow = 1
        val expectedThirdRow = listOf("50304","Innovation Semester - September 2025","2025-09-01 00:00:00+02:00","2026-01-30 23:59:59+01:00","Jane Doe","jane.doe@hu.nl","TEACHER")
        val thirdResultRow = 2
        val expectedFourthRow = listOf("50304","Innovation Semester - September 2025","2025-09-01 00:00:00+02:00","2026-01-30 23:59:59+01:00","User Null","null","STUDENT")
        val fourthResultRow = 3
        val expectedFifthRow = listOf("9999","Test cursus - September 2010","2010-09-01 00:00:00+02:00","2011-01-30 23:59:59+01:00","Test User","test.user@student.hu.nl","STUDENT")
